"""
fNIRS GATv2 optimization grader.

Runs solution.run(data_dir) using the project venv and returns the holdout F1 score.
"""
...
class Grader(TaskGrader):
    def evaluate(self) -> float | ScoreBundle:
        ...
        explanation = f"Holdout F1 = {f1:.4f}  (HBO mt2, 62 subjects, val_ratio=0.2)"
