...
The GNN's top-5 most-attended channels (S5_D5/BA46-R, S1_D1/BA10-L, S8_D5/BA9-R, S4_D4/BA9-R, S7_D4/BA8-L) span the dorsolateral, dorsomedial, and ventromedial PFC subdivisions implicated in anxiety. Two of the top-5 — **S5_D5** (right DLPFC) and **S1_D1** (left vmPFC) — are also FDR-significant in the per-channel HbO STD analysis (§3.1.3, HC > GAD with *d* = −0.92 and −0.81 respectively), confirming a hypoactivity pattern in the inhibitory-control and emotion-regulation networks. The remaining three top-5 channels (S7_D4, S4_D4, S8_D5) sit within BA 8/9 dmPFC but fall below univariate FDR — precisely the multivariate, network-level signal that a graph-based classifier is positioned to surface. At the broader set-overlap level, three of the six C6 biological-prior channels (`{S1_D1, S5_D5, S3_D3}`) appear in the ST-HbO XAI top-10, exceeding the SPEC §11 C6 ≥ 2/6 threshold. The Brodmann mapping (BA 8/9/10/46) aligns with the established GAD-PFC literature [`pokorny2024young` dlPFC inhibition deficit; `etkin2009functional` anxiety meta-analysis; `davidson2002anxiety` PFC emotion-regulation]. The agreement between the model's learned attention and the classical statistical maps is the strongest evidence that the classifier's signal is biological rather than demographic or artefactual. (sources: `02_brain_activation/REPORT.md §4.2, §4.4`; `06_glm_hrf/REPORT.md §4.2`; `docs/SPEC_xai_graph.md §11 C6`; `research/paper-materials/figures/results/xai_brain/fig_xai_brain_overlay_top5.png`; `research/paper-materials/figures/results/top5_bars/fig_top5_hbo_bars.png`).
